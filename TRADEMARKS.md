...
This is the ROUTD project's policy for the use of our trademarks. While ROUTD is
...
be full participants in the ROUTD project.

## Our trademarks

This policy covers the name "ROUTD" as well as any associated logos, trade dress,
...
say you are distributing ROUTD when you're distributing a modified version of it,
...
your website in a way that suggests that your website is an official ROUTD
website or that we endorse your website. But, if true, you can say you like
ROUTD, that you participate in the ROUTD community, that you are providing an
unmodified version of ROUTD, or that you wrote a guide describing how to use
ROUTD.
...
When you redistribute an unmodified copy of ROUTD, you are not changing the
...
you are redistributing an official ROUTD distribution that has not been changed
in any way.

## Distribution of executable code that you have compiled, or modified code

You may use the word mark "ROUTD", but not any ROUTD logos, to truthfully
describe the origin of the software that you are providing, that is, that the
code you are distributing is a modification of ROUTD. You may say, for example,
that "this software is derived from the source code for ROUTD."
...
executable) on the condition that any executable is built from an official ROUTD
...
The following clarifications apply specifically to common ways ROUTD is
redistributed:

* **Self-hosted instances of unmodified ROUTD.** You may refer to your instance
  as "a ROUTD instance" or "running ROUTD." You may not name the service itself
  in a way that suggests it is the official ROUTD ("ROUTD Cloud," "ROUTD
  Official," etc.).
* **Mobile wrappers (WebView shells, Capacitor apps, native apps) pointing at
  ROUTD.** You may describe your app as "a mobile client for ROUTD" or "for use
  with ROUTD." You may not publish it on app stores under the name "ROUTD" or a
  confusingly similar name, and you may not use the ROUTD logo as the app icon
  unless your wrapper distributes only an unmodified, official ROUTD instance
  and you have obtained permission.
* **Forks of the ROUTD source code.** Forks that diverge from upstream must use
  a different name. You may state that your fork is "based on ROUTD" or "a fork
  of ROUTD," but the project name itself must be your own.

## Statements about your software's relation to ROUTD

You may use the word mark, but not ROUTD logos, to truthfully describe the
relationship between your software and ours. The word mark "ROUTD" should be
used after a verb or preposition that describes the relationship between your
software and ours. So you may say, for example, "Bob's app for ROUTD" but may
not say "Bob's ROUTD app." Some other examples that may work for you are:

* [Your software] uses ROUTD
* [Your software] is powered by ROUTD
* [Your software] runs on ROUTD
* [Your software] for use with ROUTD
* [Your software] for ROUTD
...
is not covered, please open an issue on the ROUTD GitHub repository or contact
