...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenido a ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt':
    'Destino de viaje pintoresco con la interfaz de ROUTD',
