...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Miközben te a következő útvonaladat tervezed, ők a ROUTD jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a ROUTD Open Source maradhasson.',
  ...
  'settings.about.description':
    'A ROUTD egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
