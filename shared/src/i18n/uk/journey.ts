...
const journey: TranslationStrings = {
  ...
  'journey.deleteConfirmMessage':
    'Видалити «{title}»? Цю дію не можна скасувати.',
  ...
  'journey.editor.tagsPlaceholder':
    'Теги: прихована перлина, найкраща їжа, варто повернутися...',
  ...
  'journey.emptyState.subtitle':
    'Позначтесь у місці або напишіть перший запис у щоденник',
  'journey.frontpage.subtitle':
    'Перетворюйте поїздки на історії, які ви ніколи не забудете',
  ...
  'journey.frontpage.createNewSub':
    'Оберіть поїздки, пишіть історії, діліться пригодами',
  ...
  'journey.frontpage.suggestionText':
    'Перетворіть <strong>{title}</strong> на подорож',
  ...
  'journey.detail.noEntriesHint':
    'Додайте подорож, щоб почати зі шаблонних записів',
  'journey.detail.noPhotos': 'Поки що немає фото',
  'journey.detail.noPhotosHint':
    'Завантажте фото до записів або перегляньте бібліотеку Immich/Synology',
  ...
  'journey.editor.discardChangesConfirm':
    'У вас є незбережені зміни. Відмінити?',
  ...
  'journey.settings.subtitlePlaceholder':
    'наприклад Таїланд, В’єтнам і Камбоджа',
  ...
  'journey.public.notFoundMessage':
    'Ця подорож не існує або посилання застаріло.',
