...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Ласкаво просимо в ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt':
    'Живописне місце призначення з інтерфейсом ROUTD',
  'system_notice.welcome_v1.highlight_plan':
    'Детальні плани по днях для будь-яких поїздок',
