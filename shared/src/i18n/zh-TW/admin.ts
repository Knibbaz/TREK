...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 ROUTD 體驗。',
  ...
  'admin.weather.description':
    'ROUTD 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.update.dockerText':
    '你的 ROUTD 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
