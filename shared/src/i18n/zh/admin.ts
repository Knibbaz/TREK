...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 ROUTD 体验。',
  ...
  'admin.weather.description':
    'ROUTD 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.update.dockerText':
    '你的 ROUTD 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
