...
const dashboard: TranslationStrings = {
  ...
  'dashboard.status.concept': 'Draft',
  'dashboard.filter.all': 'All',
  'dashboard.filter.live': 'Live',
  'dashboard.filter.upcoming': 'Upcoming',
  'dashboard.filter.past': 'Past',
  'dashboard.filter.concept': 'Draft',
  'dashboard.filter.empty': 'No trips found for this filter.',
  'dashboard.stats.days': 'Days',
  'dashboard.stats.places': 'Places',
  'dashboard.stats.buddies': 'Buddies',
  'dashboard.toast.published': 'Trip published to Explore!',
  'dashboard.toast.publishError': 'Failed to publish trip',
  'dashboard.toast.submittedForReview': 'Trip submitted for review! An admin will review it shortly.',
