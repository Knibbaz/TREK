...
const system_notice: TranslationStrings = {
  ...
  'system_notice.welcome_v1.title': 'Welcome to ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt':
    'A scenic travel destination with ROUTD planning UI overlay',
