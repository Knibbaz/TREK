...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.trips:read.description':
    'Lire les voyages, jours, notes et membres',
  'oauth.scope.trips:write.label': 'Modifier les voyages et itinéraires',
  'oauth.scope.trips:write.description':
    'Créer et mettre à jour les voyages, jours, notes et gérer les membres',
  ...
  'oauth.scope.weather:read.description':
    'Obtenir les prévisions météo pour les lieux et dates de voyage',
  'oauth.scope.journey:read.label': 'Voir les journaux de voyage',
  'oauth.scope.journey:read.description':
    'Lire les journaux de voyage, les entrées et la liste des contributeurs',
  'oauth.scope.journey:write.label': 'Gérer les journaux de voyage',
  'oauth.scope.journey:write.description':
    'Créer, modifier et supprimer les journaux de voyage et leurs entrées',
