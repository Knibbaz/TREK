...
const journey: TranslationStrings = {
  ...
  'journey.timelineEmptyHint':
    'Ajoutez un check-in ou écrivez une entrée de journal pour commencer',
  ...
  'journey.editor.tagsPlaceholder':
    'Tags : pépite cachée, meilleur repas, à revisiter...',
  ...
  'journey.emptyState.subtitle':
    'Faites un check-in ou écrivez votre première entrée de journal',
  'journey.frontpage.subtitle':
    'Transformez vos voyages en histoires inoubliables',
  ...
  'journey.frontpage.createNewSub':
    'Choisissez des voyages, écrivez des récits, partagez vos aventures',
  ...
  'journey.frontpage.suggestionText':
    'Transformez <strong>{title}</strong> en journal de voyage',
  ...
  'journey.detail.noEntriesHint':
    'Ajoutez un voyage pour commencer avec des entrées préremplies',
  ...
  'journey.editor.uploadPartialFailed':
    '{failed} sur {total} photos ont échoué — sauvegardez à nouveau pour réessayer',
  ...
  'journey.settings.endDescription':
    "Masque l'indicateur En direct. Vous pouvez rouvrir à tout moment.",
  'journey.settings.delete': 'Supprimer',
  'journey.settings.deleteJourney': 'Supprimer le journal',
  'journey.settings.deleteMessage':
    'Supprimer « {title} » ? Toutes les entrées et photos seront perdues.',
