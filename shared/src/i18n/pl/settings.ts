...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość ROUTD. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby ROUTD pozostał Open Source.',
  ...
  'settings.about.description':
    'ROUTD to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
