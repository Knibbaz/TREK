...
const journey: TranslationStrings = {
  ...
  'journey.deleteConfirmMessage':
    '"{title}" loeschen? Das kann nicht rueckgaengig gemacht werden.',
  'journey.deleteConfirmGeneric':
    'Bist du sicher, dass du das loeschen moechtest?',
  ...
  'journey.timelineEmptyHint':
    'Fuege einen Check-in hinzu oder schreibe einen Tagebucheintrag',
  ...
  'journey.editor.tagsPlaceholder':
    'Tags: Geheimtipp, bestes Essen, nochmal hin...',
  ...
  'journey.emptyState.subtitle':
    'Checke an einem Ort ein oder schreibe deinen ersten Tagebucheintrag',
  'journey.frontpage.subtitle':
    'Verwandle deine Reisen in Geschichten, die du nie vergisst',
  ...
  'journey.frontpage.createNewSub':
    'Trips auswählen, Geschichten schreiben, Abenteuer teilen',
  ...
  'journey.frontpage.suggestionText':
    'Verwandle <strong>{title}</strong> in eine Journey',
  ...
  'journey.detail.noEntriesHint':
    'Füge einen Trip hinzu, um mit Skelett-Einträgen zu starten',
  'journey.detail.noPhotos': 'Noch keine Fotos',
  'journey.detail.noPhotosHint':
    'Lade Fotos hoch oder durchsuche deine Immich/Synology-Bibliothek',
  ...
  'journey.editor.uploadPartialFailed':
    '{failed} von {total} Fotos fehlgeschlagen — erneut speichern zum Wiederholen',
  ...
  'journey.contributors.removeConfirm':
    '{username} aus dieser Journey entfernen?',
  ...
  'journey.settings.endDescription':
    'Blendet das Live-Abzeichen aus. Sie können jederzeit wieder öffnen.',
  'journey.settings.delete': 'Löschen',
  'journey.settings.deleteJourney': 'Journey löschen',
  'journey.settings.deleteMessage':
    '"{title}" löschen? Alle Einträge und Fotos gehen verloren.',
  ...
  'journey.public.notFoundMessage':
    'Diese Journey existiert nicht oder der Link ist abgelaufen.',
