...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost ROUTD. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby ROUTD zůstal Open Source.',
  ...
  'settings.about.description':
    'ROUTD je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
