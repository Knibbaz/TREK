...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle':
    'Schakel functies in of uit om je ROUTD-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'ROUTD gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.update.confirmText':
    'ROUTD wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je ROUTD-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
