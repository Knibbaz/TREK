...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Welkom bij ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt':
    'Schilderachtige reisbestemming met ROUTD interface',
  ...
  'system_notice.v3_journey.highlight_timeline':
    'Dag-voor-dag tijdlijn & galerij',
  'system_notice.v3_journey.highlight_photos':
    'Importeer van Immich of Synology',
  'system_notice.v3_journey.highlight_share':
    'Openbaar delen — geen login vereist',
  ...
  'system_notice.v3_mcp.highlight_scopes':
    '24 gedetailleerde toestemmingsscopes',
  'system_notice.v3_mcp.highlight_deprecated':
    'Statische trek_-tokens verouderd',
