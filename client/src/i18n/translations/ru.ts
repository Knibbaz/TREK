const ru: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Спутники ROUTD',
  'settings.about.supporters.subtitle': 'Пока ты планируешь следующий маршрут, эти люди планируют вместе со мной будущее ROUTD. Их ежемесячный взнос идёт напрямую в разработку и реально потраченные часы — чтобы ROUTD оставался Open Source.',
  ...
  'settings.about.description': 'ROUTD — это самостоятельно размещаемый планировщик путешествий, который помогает организовать поездки от первой идеи до последнего воспоминания. Планирование по дням, бюджет, списки вещей, фото и многое другое — всё в одном месте, на вашем собственном сервере.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки ROUTD под себя.',
  ...
  'admin.weather.description': 'ROUTD использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.update.text': 'Доступна версия ROUTD {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'ROUTD будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр ROUTD работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями ROUTD',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя ROUTD для совместного календаря отпусков.',
  ...
  'notif.version_available.text': 'ROUTD {version} теперь доступен',
  ...
  'journey.pdf.madeWith': 'Сделано с помощью ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом ROUTD',
  ...
  'system_notice.v3_photos.body': 'Вкладка **Фото** в Планировщике путешествий удалена. Ваши фото в безопасности — ROUTD никогда не изменял вашу библиотеку Immich или Synology.\n\nФото теперь доступны в дополнении **Journey**. Journey необязателен — если он ещё недоступен, попросите администратора включить его в разделе Admin → Дополнения.',
