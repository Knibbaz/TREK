const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.subtitle': 'Während du deine nächste Route planst, planen diese Leute mit, wie ROUTD weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit ROUTD Open Source bleibt.',
  ...
  'settings.about.description': 'ROUTD ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  'settings.about.madeWith': 'Entwickelt mit',
  'settings.about.madeBy': 'von Bas',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um ROUTD nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description': 'ROUTD nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.update.confirmText': 'ROUTD wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText': 'Deine ROUTD-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.inviteHint': 'Lade einen anderen ROUTD-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
  ...
  'journey.pdf.madeWith': 'Erstellt mit ROUTD',
  'journey.pdf.day': 'Tag',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit ROUTD-Planungs-UI',
