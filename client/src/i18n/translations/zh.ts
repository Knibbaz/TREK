const zh: Record<string, string> = {
  ...
  'settings.about.supporters.title': '与 ROUTD 同行的伙伴',
  'settings.about.supporters.subtitle': '当你在规划下一段路线时，这些人也在一起规划 ROUTD 的未来。他们每月的支持直接用于开发与真实投入的时间——让 ROUTD 保持开源。',
  ...
  'settings.about.description': 'ROUTD 是一个自托管的旅行规划工具，帮助你从最初的想法到最后的回忆，全程组织你的旅行。日程规划、预算、行李清单、照片等——一切尽在一处，在你自己的服务器上。',
  'settings.about.madeWith': '用',
  'settings.about.madeBy': '由 Bas 和不断壮大的开源社区打造。',
  ...
  'login.createAdminHint': '为 ROUTD 设置第一个管理员账户。',
  ...
  'admin.weather.description': 'ROUTD 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.update.confirmText': 'ROUTD 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 ROUTD 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 ROUTD 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'ROUTD 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 ROUTD 用户共享合并的假期日历。',
  ...
  'notifications.versionAvailable.text': 'ROUTD {version} 现已可用。',
  ...
  'notif.version_available.text': 'ROUTD {version} 现已可用',
  ...
  'journey.pdf.madeWith': '由 ROUTD 制作',
  'journey.pdf.day': '第',
  ...
  'system_notice.v3_photos.body': '行程规划器中的​**照片**标签已被移除。您的照片安全无虑 — ROUTD 从未修改您的 Immich 或 Synology 相册。\n\n照片现在位于 **Journey** 插件中。Journey 是可选的 — 如果尚未启用，请联系管理员在 Admin → 插件 中开启。',
