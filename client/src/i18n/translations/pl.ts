const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Towarzystwo podróży dla ROUTD',
  'settings.about.supporters.subtitle': 'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość ROUTD. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby ROUTD pozostał Open Source.',
  ...
  'settings.about.description': 'ROUTD to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  'settings.about.madeWith': 'Stworzone z',
  'settings.about.madeBy': 'przez Bas\'a i rosnącą społeczność open-source.',
  ...
  'login.createAdminHint': 'Skonfiguruj pierwsze konto administratora dla ROUTD.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w ROUTD.',
  ...
  'admin.weather.description': 'ROUTD korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.update.text': 'Dostępna jest wersja ROUTD {version}. Używasz {current}.',
  ...
  'admin.update.confirmText': 'ROUTD zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText': 'Twoja instancja ROUTD działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'vacay.inviteHint': 'Zaproś innego użytkownika ROUTD do wspólnego kalendarza urlopów.',
  ...
  'notifications.versionAvailable.text': 'ROUTD {version} jest już dostępny.',
  ...
  'journey.pdf.madeWith': 'Stworzone z ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malownicze miejsce z interfejsem planowania ROUTD',
  ...
  'system_notice.v3_photos.body': '**Zdjęcia** w Planerze Podróży zostały usunięte. Twoje zdjęcia są bezpieczne — ROUTD nigdy nie modyfikował Twojej biblioteki Immich lub Synology.\n\nZdjęcia są teraz dostępne w dodatku **Journey**. Journey jest opcjonalny — jeśli jeszcze nie jest dostępny, poproś administratora o jego włączenie w Admin → Dodatki.',
