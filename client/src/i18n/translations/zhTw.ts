const zhTw: Record<string, string> = {
  ...
  'settings.about.supporters.title': '與 ROUTD 同行的夥伴',
  'settings.about.supporters.subtitle': '當你規劃下一段路線時，這些人也在一起規劃 ROUTD 的未來。他們每月的支持直接用於開發與實際投入的時間——讓 ROUTD 保持開源。',
  ...
  'settings.about.description': 'ROUTD 是一款自架旅遊規劃器，幫助您從最初構想到最後回憶，整理每次旅行。日程規劃、預算、行李清單、照片及更多功能——全部集中在您自己的伺服器上。',
  'settings.about.madeWith': '以',
  'settings.about.madeBy': '由 Bas 製作',
  ...
  'login.createAdminHint': '為 ROUTD 設定第一個管理員賬戶。',
  ...
  'admin.weather.description': 'ROUTD 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.update.confirmText': 'ROUTD 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'admin.update.dockerText': '你的 ROUTD 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '與其他 ROUTD 使用者共享你的假期計劃',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'ROUTD 使用者郵箱',
  ...
  'vacay.inviteHint': '邀請其他 ROUTD 使用者共享合併的假期日曆。',
  ...
  'vacay.modeComp': '補休',
  'vacay.compTime': '補休',
  'vacay.hoursPerDay': '每工作日小時數',
  'vacay.hoursPerDayHint': '定義多少小時等於一個完整的假期天數',
  'vacay.stdDay': '全天',
  ...
  'journey.pdf.madeWith': '由 ROUTD 製作',
  'journey.pdf.day': '第',
  ...
  'notifications.versionAvailable.text': 'ROUTD {version} 現已推出。',
  ...
  'notif.version_available.text': 'ROUTD {version} 現已推出',
  ...
  'system_notice.v3_photos.body': '行程規劃器中的​**相片**標籤已被移除。您的相片安全— ROUTD 從未修改您的 Immich 或 Synology 相簿。\n\n相片現在位於 **Journey** 附加元件中。Journey 為選用 — 若尚未啟用，請聯絡管理員於 Admin → 附加元件 中開啟。',
