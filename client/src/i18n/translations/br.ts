const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Companheiros de viagem do ROUTD',
  'settings.about.supporters.subtitle': 'Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do ROUTD. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o ROUTD continuar Open Source.',
  ...
  'settings.about.description': 'ROUTD é um planejador de viagens auto-hospedado que ajuda você a organizar suas viagens da primeira ideia à última lembrança. Planejamento diário, orçamento, listas de bagagem, fotos e muito mais — tudo em um só lugar, no seu próprio servidor.',
  ...
  'login.createAdminHint': 'Configure a primeira conta de administrador do ROUTD.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no ROUTD.',
  ...
  'admin.weather.description': 'O ROUTD usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.update.text': 'O ROUTD {version} está disponível. Você está na {current}.',
  'admin.update.button': 'Ver no GitHub',
  'admin.update.install': 'Instalar atualização',
  'admin.update.confirmTitle': 'Instalar atualização?',
  'admin.update.confirmText': 'O ROUTD será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância ROUTD roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do ROUTD',
  ...
  'vacay.inviteHint': 'Convide outro usuário ROUTD para compartilhar um calendário de férias combinado.',
  ...
  'notif.version_available.text': 'ROUTD {version} está disponível',
  ...
  'journey.pdf.madeWith': 'Feito com ROUTD',
  'journey.pdf.day': 'Dia',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viagem pitoresco com a interface do ROUTD',
  ...
  'system_notice.v3_photos.body': '**Fotos** no Planejador de Viagens foram removidas. Suas fotos estão seguras — o ROUTD nunca modificou sua biblioteca Immich ou Synology.\n\nAs fotos agora vivem no addon **Journey**. Journey é opcional — se ainda não estiver disponível, peça ao seu admin para ativá-lo em Admin → Addons.',
