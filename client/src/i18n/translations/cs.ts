const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s ROUTD',
  'settings.about.supporters.subtitle': 'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost ROUTD. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby ROUTD zůstal Open Source.',
  ...
  'settings.about.description': 'ROUTD je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  'settings.about.madeWith': 'Vytvořeno s',
  'settings.about.madeBy': 'Basm a rostoucí open-source komunitou.',
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro ROUTD.',
  ...
  'admin.weather.description': 'ROUTD používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'ROUTD {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'ROUTD bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText': 'Váš ROUTD běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli ROUTD',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele ROUTD',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele ROUTD ke sdílení společného kalendáře dovolených.',
  ...
  'notif.version_available.text': 'ROUTD {version} je nyní dostupný',
  ...
  'journey.pdf.madeWith': 'Vytvořeno pomocí ROUTD',
  'journey.pdf.day': 'Den',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním ROUTD',
  ...
  'system_notice.v3_photos.body': '**Fotografie** v Plánovacím nástroji byly odebrány. Vaše fotografie jsou v bezpečí — ROUTD nikdy neupravoval vaši knihovnu Immich nebo Synology.\n\nFotografie jsou nyní dostupné v doplňku **Journey**. Journey je volitelný — pokud ještě není k dispozici, požádejte svého správce, aby ho aktivoval v Admin → Doplňky.',
