const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Útitársak a ROUTD mellett',
  'settings.about.supporters.subtitle': 'Miközben te a következő útvonaladat tervezed, ők a ROUTD jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a ROUTD Open Source maradhasson.',
  ...
  'settings.about.description': 'A ROUTD egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
  'settings.about.madeWith': 'Készítve',
  'settings.about.madeBy': 'Bas által',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a ROUTD testreszabásához.',
  ...
  'admin.weather.description': 'A ROUTD az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.update.text': 'A ROUTD {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText': 'A ROUTD frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText': 'A ROUTD példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'vacay.inviteHint': 'Hívj meg egy másik ROUTD felhasználót közös szabadságnaptár megosztásához.',
  ...
  'journey.pdf.madeWith': 'Készítve a ROUTD segítségével',
  'journey.pdf.day': 'Nap',
  ...
  'system_notice.v3_photos.body': 'Az útiterv-tervező **Fényképek** lapja eltávolításra került. Fényképeid biztonságban vannak — ROUTD soha nem módosította Immich vagy Synology könyvtáradat.\n\nA fényképek mostantól a **Journey** bővítményben élnek. A Journey opcionális — ha még nem elérhető, kérd meg a rendszergazdát, hogy engedélyezze Admin → Bővítmények alatt.',
