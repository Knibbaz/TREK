const nl: Record<string, string> = {
  ...
  'dashboard.status.concept': 'Concept',
  'dashboard.filter.all': 'Alle',
  'dashboard.filter.live': 'Live',
  'dashboard.filter.upcoming': 'Aankomend',
  'dashboard.filter.past': 'Afgelopen',
  'dashboard.filter.concept': 'Concept',
  'dashboard.filter.empty': 'Geen reizen gevonden voor dit filter.',
  'dashboard.stats.days': 'Dagen',
  'dashboard.stats.places': 'Plekken',
  'dashboard.stats.buddies': 'Reisgenoten',
  ...
  'dashboard.toast.published': 'Reis gepubliceerd in Explore!',
  'dashboard.toast.publishError': 'Publiceren mislukt',
  'dashboard.toast.submittedForReview': 'Reis ingediend voor beoordeling! Een admin bekijkt deze binnenkort.',
  ...
  'share.permMap': 'Kaart',
  'share.permPlan': 'Plan',
  'share.permDescription': 'Beschrijving',
  'share.collabTitle': 'Uitnodigingslink',
  'share.collabHint': 'Iedereen met deze link kan deelnemen aan de reis als medewerker.',
  'share.collabCreate': 'Link aanmaken',
  'share.collabRevoke': 'Link intrekken',
  'share.collabJoin': 'Deelnemen aan reis',
  'share.collabLoginRequired': 'Log in om deel te nemen',
  'share.collabVisibleToMembers': 'Deelnemers mogen link zien',
  'share.collabRotate': 'Nieuwe link aanmaken',
  'share.permClone': 'Klonen toestaan',
  'share.cloneButton': 'Reis kopiëren',
  'share.cloneSuccess': 'Reis gekopieerd naar jouw account',
  'share.cloneError': 'Kon reis niet kopiëren',
  'share.cloneLoginRequired': 'Log in om deze reis te kopiëren',
  'share.cloneTitle': 'Voeg deze reis toe aan je dashboard',
  'share.cloneDescription': 'Kopieer deze reis om volledige details per locatie in te zien, je eigen itinerary rond deze bestemmingen in te plannen en dit als planningsbasis te gebruiken.',
  ...
  'settings.about.supporters.subtitle': 'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van ROUTD. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat ROUTD Open Source blijft.',
  ...
  'settings.about.description': 'ROUTD is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto\'s en nog veel meer — alles op één plek, op je eigen server.',
  'settings.about.madeWith': 'Gemaakt met',
  'settings.about.madeBy': 'door Bas',
  ...
  // GDPR
  'gdpr.account.pendingBanner': 'Account staat gepland voor verwijdering',
  'gdpr.account.cancelDeletion': 'Verwijdering annuleren',
  'gdpr.account.cancelSuccess': 'Verwijdering geannuleerd. Je account is veilig.',
  'gdpr.account.requestConfirm': 'Verwijdering aanvragen',
  'gdpr.account.gracePeriod': 'Je account wordt over 14 dagen verwijderd. Je kunt de verwijdering op elk moment tijdens deze periode annuleren.',
  'gdpr.account.downloadFirst': 'Download je gegevens voordat je verwijdering aanvraagt.',
  'gdpr.account.requestSuccess': 'Verwijdering aangevraagd. Je hebt 14 dagen om dit te annuleren.',
  'gdpr.deletions.title': 'Verwijderingen in afwachting',
  'gdpr.deletions.pendingCount': 'In afwachting',
  'gdpr.deletions.deleteAt': 'Verwijderen op',
  'gdpr.exports.title': 'Exportverzoeken',
  'gdpr.exports.status': 'Status',
  ...
  'admin.toast.tripTransferred': 'Reis overgedragen aan nieuwe eigenaar',
  'admin.toast.transferError': 'Reis overdragen mislukt',
  'admin.toast.userCreated': 'Gebruiker aangemaakt',
  'admin.toast.userCreatedWithEmail': 'Gebruiker aangemaakt en welkomstmail verstuurd',
  ...
  'admin.sendWelcomeEmail': 'Stuur welkomstmail met tijdelijk wachtwoord',
  'admin.sendWelcomeEmailHint': 'Er wordt automatisch een tijdelijk wachtwoord gegenereerd en per e-mail verstuurd. De gebruiker moet het bij de eerste inlog wijzigen.',
  ...
  'admin.affiliateLinksHint': 'Optioneel. Verdien commissie wanneer gebruikers hotels boeken via Booking.com.',
  'admin.bookingAffiliateId': 'Booking.com Affiliate-ID',
  'admin.bookingAffiliateIdHint': 'Jouw affiliate-ID (aid=...) van het Booking.com affiliateprogramma. Wordt toegevoegd aan hotelboekingslinks.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je ROUTD-ervaring aan te passen.',
  ...
  'admin.weather.description': 'ROUTD gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij ROUTD verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',

  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'ROUTD {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'ROUTD wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText': 'Je ROUTD-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere ROUTD-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van ROUTD-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere ROUTD-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'vacay.hours': 'uren',
  'vacay.modeComp': 'TvT verdienen',
  'vacay.compTime': 'Tijd-voor-Tijd',
  'vacay.modeTvtUsed': 'TvT opname',
  'vacay.tvtUsed': 'opgenomen',
  'vacay.tvtUsedLabel': 'TvT opgenomen',
  'vacay.vacationUsed': 'Vakantie gebruikt',
  ...
  'atlas.livedIn': 'Gewoond in',
  'atlas.volunteeredIn': 'Vrijwilligerswerk in',
  'atlas.noResidency': 'Nog geen',
  'atlas.noVolunteering': 'Nog geen',
  'atlas.addLivedIn': 'Hier gewoond',
  'atlas.addLivedInHint': 'Toevoegen aan gewoonde plekken',
  'atlas.addVolunteered': 'Vrijwilligerswerk gedaan',
  'atlas.addVolunteeredHint': 'Toevoegen aan vrijwilligerservaringen',
  'atlas.conceptShort': 'concept',
  'atlas.plannedShort': 'gepland',
  'atlas.pastShort': 'geweest',
  'atlas.legend.title': 'Legenda',
  ...
  'places.importFileHint': 'Importeer .gpx-, .kml- of .kmz-bestanden uit tools zoals Google My Maps, Google Earth of een GPS-tracker. Je kunt ook een eerder geëxporteerd GPX-bestand opnieuw importeren.',
  ...
  'places.exportGpx': 'Exporteer als GPX',
  'places.exportError': 'Exporteren mislukt',
  ...
  'places.formPrice': 'Prijs',
  'places.formPriceTypeTotal': 'Totaal',
  'places.formPriceTypePerPerson': 'Per persoon',
  ...
  'places.allPlacesAlreadyInList': 'Alle gevonden plaatsen zitten al in uw reis',
  'places.filteredExistingPlaces': '{count} plaats al in reis | {count} plaatsen al in reis',
  'places.formPhoto': 'Foto',
  'places.addPhoto': 'Foto toevoegen',
  'places.changePhoto': 'Foto wijzigen',
  'places.deletePhoto': 'Foto verwijderen',
  'places.photoHint': 'Upload een foto om deze plaats zichtbaarder te maken op de kaart',
  'places.photoUploaded': 'Foto succesvol geüpload',
  'places.photoUploadError': 'Uploaden van foto mislukt',
  'places.photoDeleted': 'Foto verwijderd',
  'places.photoDeleteError': 'Verwijderen van foto mislukt',
  'places.searchUnsplash': 'Zoek op Unsplash',
  'places.unsplashSearchPlaceholder': 'Zoek naar foto\'s...',
  'places.noPhotosFound': 'Geen foto\'s gevonden',
  'places.selectPhoto': 'Selecteer',
  'places.uploadPhoto': 'Foto uploaden',
  'places.unsplashConfiguredError': 'Unsplash is niet geconfigureerd',
  'places.unsplashSearchError': 'Zoeken op Unsplash mislukt',
  // Place Inspector
  ...
  'backup.v2.export.expiresAt': 'Vervalt op',
  'backup.v2.export.downloadsLeft': 'Downloads resterend',
  ...
  'backup.v2.restore.confirm': 'Restore bevestigen',
  'backup.v2.restore.done': 'Restore voltooid',
  'backup.v2.schedules.title': 'Geplande back-ups',
  'backup.v2.schedules.new': 'Nieuw schema',
  'backup.v2.schedules.frequency': 'Frequentie',
  'backup.v2.schedules.retention': 'Behoud',
  'backup.v2.schedules.runNow': 'Nu uitvoeren',
  ...
  'journey.pdf.madeWith': 'Gemaakt met ROUTD',
  'journey.pdf.day': 'Dag',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met ROUTD interface',
  ...
  'system_notice.v3_photos.body': "**Foto's** in de Reisplanner zijn verwijderd. Je foto's zijn veilig — ROUTD heeft je Immich- of Synology-bibliotheek nooit gewijzigd.\n\nFoto's leven nu in de **Journey**-addon. Journey is optioneel — als het nog niet beschikbaar is, vraag je admin het te activeren via Admin → Addons.",
  ...
  'admin.explore.filterPending': 'Wachtend',
  'admin.explore.filterApproved': 'Goedgekeurd',
  'admin.explore.filterRejected': 'Afgewezen',
  'admin.explore.submittedBy': 'Ingediend door',
  'admin.explore.preview': 'Bekijk',
  'admin.explore.price': 'Prijs',
  'admin.explore.community': 'Community',
  'admin.explore.autoApprovedBadge': '✓ Auto-goedgekeurd',
  'admin.explore.autoApproveToggle': 'Automatisch goedkeuren',
  'admin.explore.approve': 'Goedkeuren',
  'admin.explore.reject': 'Afwijzen',
  'admin.explore.rejectConfirm': 'Indiening "{title}" afwijzen?',
  'admin.explore.approveSuccess': '"{title}" goedgekeurd',
  'admin.explore.approveError': 'Goedkeuren mislukt',
  'admin.explore.rejectSuccess': 'Indiening afgewezen',
  'admin.explore.rejectError': 'Afwijzen mislukt',
  'admin.explore.emptyPending': 'Geen wachtende indieningen',
  'admin.explore.emptyApproved': 'Geen goedgekeurde indieningen',
  'admin.explore.emptyRejected': 'Geen afgewezen indieningen',
  'admin.explore.free': 'Gratis',
  ...
  'admin.creatorFeePercentHint': 'Percentage dat het platform inhoudt per verkoop. Leeg = gebruik standaard fee.',
  'admin.molliePaymentMethods': 'Betalingsmethodes',
  'admin.molliePaymentMethodsHint': 'Mollie transactiekosten per betaalmethode',
  'admin.mollieMethod': 'Methode',
  'admin.mollieFixedFee': 'Vast bedrag',
  'admin.molliePercentage': 'Percentage',
  'admin.mollieMethodPlaceholder': 'bijv. iDEAL',
  'admin.noPaymentMethods': 'Geen betalingsmethodes geconfigureerd',
  'admin.mollieAddMethod': 'Methode toevoegen',
  'admin.platformFee': 'Platform fee',
  'admin.platformFeeHint': 'Standaard percentage dat het platform inhoudt bij elke verkoop.',
  'admin.platformFeeLabel': 'Fee percentage (%)',
  'admin.platformFeePlaceholder': 'Bijv. 10',
  'admin.tabs.payouts': 'Payouts',
  'admin.payouts.title': 'Creator payouts',
  'admin.payouts.selectCreator': 'Selecteer creator',
  'admin.payouts.amountPlaceholder': 'Bedrag (€)',
  'admin.payouts.descriptionPlaceholder': 'Omschrijving (optioneel)',
  'admin.payouts.register': 'Registreer',
  'admin.payouts.creators': 'Creators',
  'admin.payouts.noCreators': 'Geen creators gevonden',
  'admin.payouts.sales': 'Verkopen',
  'admin.payouts.earned': 'Verdiend',
  'admin.payouts.paid': 'Uitbetaald',
  'admin.payouts.balance': 'Openstaand',
  'admin.payouts.history': 'Uitbetalingsgeschiedenis',
  'admin.payouts.noPayouts': 'Nog geen payouts geregistreerd',
  'admin.payouts.loadError': 'Payouts laden mislukt',
  'admin.payouts.saved': 'Payout geregistreerd',
  'admin.payouts.saveError': 'Payout registreren mislukt',
  ...
  'visitorPoll.title': 'Hoe heb je ROUTD gevonden?',
  'visitorPoll.social_media': 'Social media',
  'visitorPoll.friend': 'Vriend of familie',
  'visitorPoll.search_engine': 'Zoekmachine',
  'visitorPoll.blog_website': 'Blog of website',
  'visitorPoll.other': 'Anders',
  'visitorPoll.thanks': 'Bedankt voor je antwoord!',
  'admin.tabs.insights': 'Bezoekersinzicht',
  'admin.insights.title': 'Bezoekersinzicht',
  'admin.insights.subtitle': 'Waar bezoekers van publieke pagina\'s vandaan komen',
  'admin.insights.period': 'Periode',
  'admin.insights.days': 'dagen',
  'admin.insights.totals': 'Bezoeken per paginatype',
  'admin.insights.referrers': 'Top referrers',
  'admin.insights.utmSources': 'UTM-/ref-bronnen',
  'admin.insights.survey': 'Poll: hoe heb je ROUTD gevonden?',
  'admin.insights.recent': 'Recente bezoeken',
  'admin.insights.visits': 'Bezoeken',
  'admin.insights.unique': 'Uniek',
  'admin.insights.direct': 'Direct / onbekend',
  'admin.insights.empty': 'Nog geen data voor deze periode',
  'admin.insights.pageType.shared_trip': 'Gedeelde reis',
