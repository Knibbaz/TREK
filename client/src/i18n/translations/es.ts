const es: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compañía de viaje para ROUTD',
  'settings.about.supporters.subtitle': 'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de ROUTD. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que ROUTD siga siendo Open Source.',
  ...
  'settings.about.description': 'ROUTD es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  'settings.about.madeWith': 'Hecho con',
  'settings.about.madeBy': 'por Bas',
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de ROUTD.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en ROUTD.',
  ...
  'admin.weather.description': 'ROUTD utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.update.text': 'ROUTD {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'ROUTD se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText': 'Tu instancia de ROUTD se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de ROUTD',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de ROUTD a compartir un calendario combinado de vacaciones.',
  ...
  'notif.version_available.text': 'ROUTD {version} ya está disponible',
  ...
  'journey.pdf.madeWith': 'Hecho con ROUTD',
  'journey.pdf.day': 'Día',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de ROUTD',
  ...
  'system_notice.v3_photos.body': '**Fotos** en el Planificador de Viajes han sido eliminadas. Tus fotos están a salvo — ROUTD nunca modificó tu biblioteca de Immich o Synology.\n\nLas fotos ahora viven en el addon **Journey**. Journey es opcional — si aún no está disponible, pide a tu admin que lo active en Admin → Complementos.',
