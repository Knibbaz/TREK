const fr: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compagnons de voyage pour ROUTD',
  'settings.about.supporters.subtitle': 'Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l\'avenir de ROUTD. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que ROUTD reste Open Source.',
  ...
  'settings.about.description': 'ROUTD est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.',
  'settings.about.madeWith': 'Fait avec',
  'settings.about.madeBy': 'par Bas',
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour ROUTD.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience ROUTD.',
  ...
  'admin.weather.description': 'ROUTD utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.update.text': 'ROUTD {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'ROUTD sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText': 'Votre instance ROUTD fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs ROUTD',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur ROUTD à partager un calendrier de vacances combiné.',
  ...
  'reservations.addManual': 'Réservation',
  ...
  'notifications.versionAvailable.text': 'ROUTD {version} est maintenant disponible.',
  ...
  'journey.pdf.madeWith': 'Créé avec ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destination de voyage pittoresque avec l\'interface ROUTD',
  ...
  'system_notice.v3_photos.body': "**Photos** dans le planificateur ont été supprimées. Tes photos sont en sécurité — ROUTD n'a jamais modifié ta bibliothèque Immich ou Synology.\n\nLes photos vivent désormais dans l'addon **Journey**. Journey est optionnel — s'il n'est pas encore disponible, demande à ton admin de l'activer dans Admin → Modules.",
