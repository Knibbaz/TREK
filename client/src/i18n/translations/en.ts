const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.subtitle': "While you're planning your next route, these folks are helping plan ROUTD's future. Their monthly contribution goes straight into development and real hours spent — so ROUTD stays Open Source.",
  ...
  'settings.about.description': 'ROUTD is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  'settings.about.madeWith': 'Made with',
  'settings.about.madeBy': 'by Bas',
  ...
  // GDPR
  'gdpr.account.pendingBanner': 'Account scheduled for deletion',
  'gdpr.account.cancelDeletion': 'Cancel deletion',
  'gdpr.account.cancelSuccess': 'Deletion cancelled. Your account is safe.',
  'gdpr.account.requestConfirm': 'Request deletion',
  'gdpr.account.gracePeriod': 'Your account will be deleted in 14 days. You can cancel the deletion at any time during this period.',
  'gdpr.account.downloadFirst': 'Consider downloading your data first before requesting deletion.',
  'gdpr.account.requestSuccess': 'Deletion requested. You have 14 days to cancel.',
  'gdpr.deletions.title': 'Pending Deletions',
  'gdpr.deletions.pendingCount': 'Pending',
  'gdpr.deletions.deleteAt': 'Delete at',
  'gdpr.exports.title': 'Export Requests',
  ...
  'login.createAdminHint': 'Set up the first admin account for ROUTD.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your ROUTD experience.',
  ...
  'admin.weather.description': 'ROUTD uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.update.text': 'ROUTD {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'ROUTD will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your ROUTD instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.inviteHint': 'Invite another ROUTD user to share a combined vacation calendar.',
  ...
  'places.importFileHint': 'Import .gpx, .kml or .kmz files from tools like Google My Maps, Google Earth, or a GPS tracker. You can also re-import a previously exported GPX file.',
  ...
  'system_notice.v3_photos.body': '**Photos** in the Trip Planner have been removed. Your photos are safe — ROUTD never modified your Immich or Synology library.\n\nPhotos now live in the **Journey** addon. Journey is optional — if it is not yet available, ask your admin to enable it under Admin → Addons.',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with ROUTD planning UI overlay',
  ...
  'visitorPoll.title': 'How did you find ROUTD?',
  'visitorPoll.social_media': 'Social media',
  'visitorPoll.friend': 'Friend or family',
  'visitorPoll.search_engine': 'Search engine',
  'visitorPoll.blog_website': 'Blog or website',
  'visitorPoll.other': 'Other',
  'visitorPoll.thanks': 'Thanks for your answer!',
