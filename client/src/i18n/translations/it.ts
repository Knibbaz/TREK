const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Compagni di viaggio per ROUTD',
  'settings.about.supporters.subtitle': 'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di ROUTD. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere ROUTD Open Source.',
  ...
  'settings.about.description': 'ROUTD è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all\'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.',
  'settings.about.madeWith': 'Fatto con',
  'settings.about.madeBy': 'da Bas',
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per ROUTD.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza ROUTD.',
  ...
  'admin.weather.description': 'ROUTD utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.update.text': 'ROUTD {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'ROUTD verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText': 'La tua istanza ROUTD è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.inviteHint': 'Invita un altro utente ROUTD a condividere un calendario ferie combinato.',
  ...
  'notif.version_available.text': 'ROUTD {version} è ora disponibile',
  ...
  'journey.pdf.madeWith': 'Creato con ROUTD',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinazione di viaggio panoramica con l\'interfaccia ROUTD',
  ...
  'system_notice.v3_photos.body': '**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro — ROUTD non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey è opzionale — se non è ancora disponibile, chiedi al tuo admin di abilitarlo in Admin → Addon.',
