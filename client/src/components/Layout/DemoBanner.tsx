...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur ROUTD Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the ROUTD Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de ROUTD',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من ROUTD',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo ROUTD',
