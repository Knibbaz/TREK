...
The Settings page lets you personalise every aspect of ROUTD — appearance, maps, notifications, offline behaviour, and your account.
...
If your account requires MFA setup, ROUTD redirects you directly to the **Account** tab (via `?mfa=required`).
