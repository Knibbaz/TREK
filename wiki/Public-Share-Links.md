...
Share a read-only view of your trip with people who do not have a ROUTD account. The viewer opens in a browser without logging in.
...
Copy this URL and send it to anyone you want to share the trip with. No ROUTD account is required to view it.
