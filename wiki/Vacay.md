...
Days that overlap with any of your existing ROUTD trips are marked with a small blue dot in the corner.
...
You can invite other ROUTD users to fuse their Vacay plan with yours. Once a user accepts, your plans are merged: you see each other's logged days in distinct colours, and you can log days on behalf of the other person if needed.
