...
Invite new users to register on your ROUTD instance, even when open registration is disabled. Invite links work by embedding a short-lived token in the registration URL.
