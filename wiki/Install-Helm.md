...
```bash
helm repo add trek https://mauriceboe.github.io/ROUTD
helm repo update
```
...
See the [`charts/README.md`](https://github.com/mauriceboe/ROUTD/blob/main/charts/README.md) for all available values.
