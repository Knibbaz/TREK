...
Install ROUTD on Portainer using a Stack (Docker Compose).
...
3. Select **Web editor** and paste the compose file from [docker-compose.yml](https://github.com/mauriceboe/ROUTD/blob/main/docker-compose.yml).
...
See https://github.com/mauriceboe/ROUTD/blob/main/docker-compose.yml
